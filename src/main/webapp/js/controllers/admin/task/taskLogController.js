...
define(['angular','app', 'services/api/task/log/resources'], function(angular, app){
  'use strict';
  app.controller('admin/task/taskLogController',
      ['$scope','api/task/log/resources','$modal', '$location', '$cookies','$filter', 
        function ($scope,$taskResources, $modal, $location, $cookies,$filter) {
          console.log('task LogController');
